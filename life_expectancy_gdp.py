...
#China and USA look like they move the most along the X axis over the years.
#Zimbabwe moves the most along the Y axis over the years
#Not suprising due to the previous graphs
#The scatter plots are not easy to read. 
#It's hard to see an overall trend because of the way the scatter plots are arranged and the lack of reference. 
...
# Zimbabwe has the most drastic change. 
# The dip between 2000 and 2004.
# Mexico appears to have the smallest about of change.
# In Zimbabwe it looks like there was some sort of crisis between 2000 and 2004 which led to a decrease in life span.
# The health efforts over 2005 to 2015 have been very successful. 
# In China there is a continued steady increase which indicates industrialization. 
# They are approaching developed country's life expancey rates. 
...
#Germany highest life expectancy
...
# Effect of LE increasing, increases GDP?
